...
const atomicT = async () => {
  try {
    let uncleA = algosdk.generateAccount();
    let uncleB = algosdk.generateAccount();
    let uncleC = algosdk.generateAccount();
    console.log(uncleA.addr, uncleB.addr, uncleC.addr);
    await keypress();
    ...
    let signedTx1 = transaction1.signTxn(uncleA.sk);
    let signedTx2 = transaction2.signTxn(uncleB.sk);
    let signed = [];
